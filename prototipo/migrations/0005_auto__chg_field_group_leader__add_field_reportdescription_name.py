...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Group.leader'
        db.alter_column('prototipo_group', 'leader_id', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, null=True, to=orm['prototipo.Student']))

        # Adding field 'ReportDescription.name'
        db.add_column('prototipo_reportdescription', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'Group.leader'
        db.alter_column('prototipo_group', 'leader_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prototipo.Student']))

        # Deleting field 'ReportDescription.name'
        db.delete_column('prototipo_reportdescription', 'name')
    ...
    models = {
        ...
        'prototipo.group': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'leader': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'led_group'", 'null': 'True', 'to': "orm['prototipo.Student']"}),
