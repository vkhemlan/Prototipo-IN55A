...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('prototipo_student', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prototipo.Group'], null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Student.group'
        db.alter_column('prototipo_student', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prototipo.Group']))
