...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Report.filename'
        db.delete_column('prototipo_report', 'filename')


    def backwards(self, orm):
        
        # Adding field 'Report.filename'
        db.add_column('prototipo_report', 'filename', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)
