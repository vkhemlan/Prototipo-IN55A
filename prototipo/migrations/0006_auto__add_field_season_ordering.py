...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Season.ordering'
        db.add_column('prototipo_season', 'ordering', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Season.ordering'
        db.delete_column('prototipo_season', 'ordering')
