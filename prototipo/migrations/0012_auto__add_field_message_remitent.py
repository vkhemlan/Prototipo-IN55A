...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Message.remitent'
        db.add_column('prototipo_message', 'remitent', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Message.remitent'
        db.delete_column('prototipo_message', 'remitent_id')
    ...
    models = {
        ...
        'prototipo.message': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'remitent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
